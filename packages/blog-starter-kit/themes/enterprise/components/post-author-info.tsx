			...
			<div className="mb-4 flex w-full flex-1 flex-row md:mb-0 ">
				<div className="mr-4 flex flex-row md:mb-0">
					<a
						...
						className="block h-10 w-10 overflow-hidden rounded-full border border-slate-800 md:h-14 md:w-14 "
					>
						<CustomImage
							className="block"
							placeholder="blur"
				...
				>
					<div className="flex flex-row items-center md:mb-1">
						<h1 className="prose font-sans text-lg font-semibold text-slate-100">
							<a className='text-slate-100 no-underline hover:text-sky-500' href={`https://hashnode.com/@${author.username}` }>{author.name}</a>
						</h1>
					</div>
					{author.bio?.html && (
						<div className="hidden pr-2 md:block">
							<div
								className="prose-dark prose text-slate-300"
