...
export const PostTOC = () => {
	...
	return (
		<div className="w-full px-5">
			<div className="mx-auto w-full max-w-screen-md rounded-lg border border-b-4 border-r-4 border-neutral-800 p-5 text-base leading-snug text-neutral-50 md:p-8 md:text-lg">
