		...
		<DialogPrimitive.Root open>
			<DialogPrimitive.Portal>
				...
				<DialogPrimitive.Content
					...
					} fixed bottom-0 left-0 top-0 z-50 flex w-80 transform flex-col  border-neutral-800 bg-neutral-950 shadow-2xl duration-300 ease-out`}
				>
						...
						<div className="flex items-center justify-between pl-8 pr-4">
							...
							<DialogPrimitive.Close asChild>
								<Button
									...
									className="rounded-xl !border-transparent bg-neutral-800 !px-3 !py-2 text-white"
									onClick={() => {
										toggleSidebar();
									}}
								/>
						...
						<section className="mb-10">
							<ul className="flex flex-col gap-2 text-white">
								<li>
									<Link
										href="/"
										className="transition-200 block truncate text-ellipsis whitespace-nowrap rounded p-2 px-3 transition-colors  hover:bg-neutral-800 hover:text-white"
									>
										Home
									</Link>
								</li>
