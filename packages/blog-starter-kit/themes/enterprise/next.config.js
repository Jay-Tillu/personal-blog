...
const config = {
	...
	async rewrites() {
		return [
			...
			{
				source: "/blogs",
				destination: "https://personal-blog-al30sgbf4-jay-tillus-projects.vercel.app/blogs",
			},
			{
				source: "/blogs/:path*",
				destination: "https://personal-blog-al30sgbf4-jay-tillus-projects.vercel.app/blogs/:path*",
			},
		];
	},
	async redirects() {
