				...
				<Container className="flex flex-col items-stretch gap-10 px-5 pb-10">
					...
					{allPosts.length === 0 && (
						<div className="grid grid-cols-1 py-20 lg:grid-cols-3">
							<div className="col-span-1 flex flex-col items-center gap-5 text-center text-neutral-400 lg:col-start-2">
								<div className="w-20">
					...
					{allPosts.length > 0 && (
						<div className="grid grid-cols-4 rounded-lg bg-neutral-900 px-5 py-5 md:py-10">
							<div className="col-span-full md:col-span-2 md:col-start-2">
								<h2 className=" text-primary-500 mb-5 text-center text-lg font-semibold">
